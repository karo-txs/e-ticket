...
public class CadastroFilmes {
    public static void main(String[] args) throws CadastroInexistenteException, DadosInvalidosException{
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\40 Dias - O Milagre da Vida.png");
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\Amizade Maldita.png");
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\Cadê Você, Bernadette.png");
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\Hellboy.png");
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\Invasão ao Serviço Secreto.png");
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\Maria e João.png");
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\O Segredo Ouse Sonhar.png");
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\Um dia de Chuva em Nova York.png");
        ...
        FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\Veneza.png");
       ...
       FachadaLocais.getInstance().cadastrarComCapa(f1, "src\\br\\unicap\\eticket\\imagens\\filmesCapas\\encare a musica.png");
    }
}
