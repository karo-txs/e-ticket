...
public abstract class Entretenimento implements Serializable{
    ...
    @Lob
    @Column(name = "ent_capa", nullable = false, columnDefinition = "mediumblob")
    private byte[] capa;
    ...
    public Entretenimento(String nome, String autor, int duracao, String sinopse) {
        this.nome = nome;
        this.diretor = autor;
    ...
    public Entretenimento(String nome, String diretor, int duracao, String sinopse, byte[] capa) {
        this(nome,diretor,duracao,sinopse);
        this.capa = capa;
    }

    public Entretenimento(String nome, String diretor, int duracao, Classificacao classificacao,String sinopse) {
        this(nome,diretor,duracao,sinopse);
    ...
    public String toString() {
        return "Entreterimento{" + "id=" + id + ", nome=" + nome + ", diretor=" + diretor + ", duracao=" + duracao + ", sinopse=" + sinopse + ", nota=" + nota + ", qtdeEspectadores=" + qtdeEspectadores + ", capa=" + capa + '}';
    }
