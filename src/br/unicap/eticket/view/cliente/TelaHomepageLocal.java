...
public class TelaHomepageLocal extends javax.swing.JPanel {

    private LocalGenerico local;
    private Cliente cliente;

    public TelaHomepageLocal(LocalGenerico local, Cliente cliente) {
        initComponents();
        this.local = local;
    ...
    private void initComponents() {
        ...
        lblEntretenimentoMsg.setText("Sem entretenimentos cadastrados no momento!");
        add(lblEntretenimentoMsg, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 240, 410, 30));
        ...
        jpnScrollInterno.setPreferredSize(new java.awt.Dimension(930, 1200));
        jpnScrollInterno.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jpnScroll.setViewportView(jpnScrollInterno);

        add(jpnScroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 280, -1, -1));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 240, 1366, 5000));
    ...
    private void lblEmCartazMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEmCartazMouseClicked
        ...
        // FrameInicio.getFrame().setContentPane(new TelaHomepageLocal(local));
        //FrameInicio.getFrame().revalidate();
